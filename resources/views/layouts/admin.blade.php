...
<body class="bg-slate-100 text-slate-800">
    <aside id="adminSidebar" class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col border-r border-slate-200 bg-white transition-all duration-300 lg:translate-x-0">
        <div class="flex h-16 items-center border-b border-slate-200 px-4">
            ...
            <span class="brand-text ml-2 text-sm font-bold text-slate-800">Admin SMKN 2</span>
        </div>
        ...
        <nav class="space-y-1 p-3">
            ...
            <a href="{{ route('admin.kelas.index') }}" class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.kelas.*') ? 'bg-sky-50 text-sky-700' : 'text-slate-700 hover:bg-slate-100' }}"><span class="menu-icon">K</span><span class="sidebar-label">Kelas</span></a>
            ...
            <a href="{{ route('admin.peminjaman.index') }}" class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('admin.peminjaman.*') ? 'bg-sky-50 text-sky-700' : 'text-slate-700 hover:bg-slate-100' }}"><span class="menu-icon">P</span><span class="sidebar-label">Peminjaman</span></a>
